...
public class ATMimpl implements ATM {
    ...
    public boolean acceptNotes(Amount amount) {
       return  block.acceptProcessing(amount, new AmountSelector(new AmountSelection_MaxNotes()), true);
    }

    @Override
    public boolean deliverNotes(Amount amount) {
       return block.deliverProcessing(amount, new AmountSelector(new AmountSelection_MaxNotes()), true);
    }
